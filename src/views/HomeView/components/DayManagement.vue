          ...
          <template v-if="props.data.length > 0">
            ...
            <v-list rounded>
              <v-list-item v-for="(task, index) in props.data" :key="index">
                ...
                <template #append>
                  <v-btn @click="taskFormEditDialog = true; selectedTask = task" color="warning" icon="mdi-pencil" variant="text" class="mx-1"></v-btn>
                  <v-btn @click="confirmDialog = true; selectedTask = task" color="error" icon="mdi-trash-can" variant="text" class="mx-1"></v-btn>
                </template>
...
<!--  Modals -->
  <confirm-dialog
    ...
    v-model="confirmDialog"></confirm-dialog>
